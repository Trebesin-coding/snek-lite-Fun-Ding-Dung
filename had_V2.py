...
bod2 = pygame.transform.rotozoom(bod2, 0, 0.5)

random2_x = random.randint(50, screen_width- 50)
random2_y = random.randint(50, screen_height -50)

bod2_hitbox = bod2.get_rect(midbottom=(random2_x, random2_y))
...
while running:
    ...
    if evolution > 3:
        ...
        if had_hitbox.colliderect(bod2_hitbox):
            super_evolution += 1
